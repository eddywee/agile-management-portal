...
export function openUpdateModal() {
  useModalStore.getState().showModal('Software Update', <UpdateModalContent />, null);
}

function UpdateModalContent() {
  const { update, downloadStatus, downloadPercent, errorMessage, startDownload, dismissSession, skipVersion } =
    useUpdateStore();
  ...
  const isActive =
    downloadStatus === 'downloading' || downloadStatus === 'installing' || downloadStatus === 'restarting';
  ...
  return (
    <>
      <div className="modal-body">
        ...
        {isActive && (
          <div className="update-modal__progress">
            <div className="update-modal__progress-bar">
              <div className="update-modal__progress-fill" style={{ width: `${downloadPercent}%` }} />
            </div>
        ...
        {downloadStatus === 'failed' && <div className="update-modal__error">Update failed: {errorMessage}</div>}
      </div>
      <div className="modal-actions">
        {!isActive && (
          <>
            ...
            <button className="btn btn-outline btn-sm" onClick={handleRemind}>
              Remind Me Later
            </button>
